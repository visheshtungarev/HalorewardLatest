...
import {
    ClockCircleOutlined, CreditCardOutlined
                            ...
                            <div className="couponFrame text-center">
                                ...
                                <div className="d-inline-flex mt-3">
                                    <Badge
                                        ...
                                        badgeType={"oncard"}
                                        badgeText={"ON CARD"}
                                        badgeIcon={<CreditCardOutlined />}
                                    /> &nbsp;&nbsp;
                                    <Badge
                                        position={'mx-auto'}
                                        badgeType={"Instore"}
                                        badgeText={"Instore & online"}
                                        badgeIcon={<BsBasket3 />}
                                    />
                                </div>
                                <h5 className="text-center fw-bold pt-3 pb-4">Win a chance to meet Manchester United Team +
                                    Get a chance to click selfies with them</h5>


                                <Button type="primary" className="px-5 ml-auto">Link your card</Button>
